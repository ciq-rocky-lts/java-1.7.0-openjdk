...
%license %{_jvmdir}/%{sdkdir}/ASSEMBLY_EXCEPTION
%license %{_jvmdir}/%{sdkdir}/LICENSE
%license %{_jvmdir}/%{sdkdir}/THIRD_PARTY_README
%dir %{_jvmdir}/%{sdkdir}
...
* Wed Jul 17 2024 Matt Hink <mhink@ciq.com> - 1:1.7.0.261-2.6.22.4
- Fix CVE-2022-34169

* Wed Jul 17 2024 Matt Hink <mhink@ciq.com> - 1:1.7.0.261-2.6.22.3
- Fix CVE-2022-21476

* Wed Apr 15 2020 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.261-2.6.22.2
- Modify NEWS installation to avoid subpackage naming.
- Resolves: rhbz#1810557

* Tue Apr 14 2020 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.261-2.6.22.1
- Add release notes from IcedTea.
- Mark license files with appropriate macro.
- Resolves: rhbz#1810557

* Mon Apr 13 2020 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.261-2.6.22.0
- Bump to 2.6.22 and OpenJDK 7u261-b02.
- Resolves: rhbz#1810557

* Thu Feb 06 2020 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.251-2.6.21.1
- Bump to 2.6.21 and OpenJDK 7u251-b02.
- Resolves: rhbz#1785753

* Tue Oct 15 2019 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.241-2.6.20.1
...
* Fri Aug 23 2019 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.231-2.6.19.3
